...
simdesc = 'flexM1e71HzC2'; % Use this if you want to add a short description of why you're running the simulation.  
...
for nouterloop1 = 1:length(outersweepvals1)
    for nouterloop2 = 1:size(outersweepvals2,1)
        ...
        t_on_dur = 2.01; %00e-3; % (seconds) duration of acceleration phase, after which beam is turned off
        ...
        t0t_x0 = 0.02*radiusmm;
        t0t_y0 = 0.02*radiusmm;
        t0t_t0_x = deg2rad(-1); % (rad), initial tilt of sail about the x axis
        t0t_t0_y = deg2rad(-1); % (rad), initial tilt of sail about the y axis
...
%         snapshot_interval_s = 0.1;%0.020;%.250;
        snapshot_interval_s = 0.2;%0.020;%.250;
