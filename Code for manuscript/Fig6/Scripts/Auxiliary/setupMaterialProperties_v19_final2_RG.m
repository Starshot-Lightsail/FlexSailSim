...
MATERIALS(4).Iabs = Iabs_Si3N4_TE; % absorptivity
MATERIALS(4).Irefl = 0.15; % reflectivity
MATERIALS(4).Emissivity = Emissivity_Si3N4; % emissivity
...
MATERIALS(5).Iabs = Iabs_Si3N4_TM; % absorptivity
MATERIALS(5).Irefl = 0.15; % reflectivity
MATERIALS(5).Emissivity = Emissivity_Si3N4; % emissivity
