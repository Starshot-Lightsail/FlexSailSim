...
% x0 = 0.05D, y0 = 0.05D, theta0 = -2 deg, phi0 = -2 deg, w = 0.4D

% Change (07/23/23): Run simulation with tighter tolerances for review
...
tend = 310.12028577; % in units of t0, or: normalized by t0
