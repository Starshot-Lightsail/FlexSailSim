...
% plotAnoStr3 = { ...
%     ['Reg mass: ' sprintf('%6g ', rmap_mass)      'g'  ] ...
%     ['Reg area:   ' sprintf('%6g ', rmap_area./1e6) 'm2' ] ...
...
plotAnoStr3 = { ...
    ...
    ['Nom rad: ' num2str(radActualx0mm) ' mm' ] ...
    ['dt = ' num2str( dt ) ' s'] ...
    ['Tensile margin = ' num2str(round(100*(1-max(e_s(e_notbroken)./e_tensile_strain_limit(e_notbroken))),2)) '% [' num2str(tensilefailures) ']' ] ...
    ['Thermal margin = ' num2str(round(-max(e_t(e_notbroken) - e_failtemp(e_notbroken))),2) ' (K) ['  num2str(thermalfailures) ']' ] ...
    ['nt/nto/nf = ' num2str(nt) ' / ' num2str(nto) ' / ' num2str(nf) ] };
...
% %         ['Ang vel Rigid = [ ' num2str(angVelRigid(1)) ', ' num2str(angVelRigid(2)) ', ' num2str(angVelRigid(3)) ' ]' ] ...
% %         ['Up = [ ' num2str(mySailNorm(1)) ', ' num2str(mySailNorm(2)) ', ' num2str(mySailNorm(3)) ' ]' ] ...
%         [sprintf('%d',movieNum) '   Mode = flexible']};
