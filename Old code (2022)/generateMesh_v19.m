...
radialRings = 16  ; % Number of meshed ring layers spanning radially from the origin to the outer boundary of the lightsail.  
...
zAspectRatio = .48;%.2;  % a relative measure of the height of the sail strucutre produced by the non-flat node generators. 
...
tether_payload_mass = .09290*outersweepval1; %grams  5this is to vary the payload mass as a fraction of sail mass.
tether_k = 10;  % tether spring constant...  I should probably come up with a formula that scales better, but this value has worked so far.
%
