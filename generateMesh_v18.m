...
%             if pizza_thick( regi )
%                 t_thick(nt) = MATERIALS(pizza_material(regi)).thickness;
%                 t_ymod(nt) = MATERIALS(pizza_material(regi)).Ymod;
%                 t_emod(nt) = MATERIALS(pizza_material(regi)).Emod;
%                 t_nu(nt) = MATERIALS(pizza_material(regi)).nu;
%                 t_thermcd(nt) = MATERIALS(pizza_material(regi)).Thermcondmm;
%                 t_heatCap(nt) = MATERIALS(pizza_material(regi)).heatCap;
%                 t_CTE(nt) = MATERIALS(pizza_material(regi)).CTE;
%                 t_emis(nt) = MATERIALS(pizza_material(regi)).Emissivity;
%                 t_Iabs(nt) = MATERIALS(pizza_material(regi)).Iabs;
%                 t_Irefl(nt) = MATERIALS(pizza_material(regi)).Irefl;
%             end
        ...
        elseif isequal(texture_map_mode, 'stuffedcrust')
            ...
            if (t_centroid_r(nt) >  pizza_crust_radii(regi) )
                if pizza_crust_texs(regi) > 0
                    ...
                    dotex = 1;
                    t_thick(nt) = pizza_crust_thick( regi );
                    t_ymod(nt) = pizza_crust_ymod( regi );
                end
