...
if ~exist('LUTThetaStepDeg')
    ...
    if strcmpi(material,'silicon')
        ...
        LUTs(1) = LoadLUT_v17(  ...
            ...
            'pressure_TE_small_tables', LUTPsiStepDeg, LUTThetaStepDeg, showLUTPlots, 0, Iabs);
        
        LUTs(2) = LoadLUT_v17(  ...
            [fullfile('Data',file_name_collection_small_tables) 'TM.mat'], ...
            'pressure_TM_small_tables', LUTPsiStepDeg, LUTThetaStepDeg, showLUTPlots, 1, Iabs);
    ...
    elseif strcmpi(material,'nitride')
        ...
        LUTs(1) = LoadLUT_v17(  ...
            [fullfile('Data',file_name_collection_small_tables) 'TE.mat'], ...
            'pressure_TE_small_tables', LUTPsiStepDeg, LUTThetaStepDeg, showLUTPlots,0, 1e-5);
        if (showLUTPlots)
        ...
        LUTs(2) = LoadLUT_v17( ...
            [fullfile('Data',file_name_collection_small_tables) 'TM.mat'], ...
            'pressure_TM_small_tables', LUTPsiStepDeg, LUTThetaStepDeg, showLUTPlots,1, 1e-5);
        if showLUTPlots
